...
class SearchAddon extends Lifecycle_1.Disposable {
    constructor(options) {
        ...
        this._selectedDecoration = this.register(new Lifecycle_1.MutableDisposable());
        this._linesCacheTimeoutId = 0;
        this._linesCacheDisposables = new Lifecycle_1.MutableDisposable();
        this._onDidChangeResults = this.register(new EventEmitter_1.EventEmitter());
    ...
    activate(terminal) {
        ...
        this.register((0, Lifecycle_1.toDisposable)(() => this.clearDecorations()));
    }
    _updateMatches() {
    ...
    clearDecorations(retainCachedSearchTerm) {
        ...
        (0, Lifecycle_1.disposeArray)(this._highlightDecorations);
        this._highlightDecorations = [];
    ...
    _initLinesCache() {
        ...
        if (!this._linesCache) {
            ...
            this._linesCacheDisposables.value = (0, Lifecycle_1.getDisposeArrayDisposable)([
        ...
        if (options) {
            ...
            if (marker) {
                ...
                if (decoration) {
                    ...
                    disposables.push(decoration.onDispose(() => (0, Lifecycle_1.disposeArray)(disposables)));
    ...
    _createResultDecoration(result, options) {
        ...
        if (findResultDecoration) {
            ...
            disposables.push(findResultDecoration.onDispose(() => (0, Lifecycle_1.disposeArray)(disposables)));
        }
